---
name: charlie-operations-finance
description: "Run the back-office — cashflow management, team building basics, and the virtual assistant masterclass. Use when the user is dealing with cashflow, agency finances, hiring, team management, SOPs, delegation, or building a remote/VA team. Sub-topics: managing-finances-cashflow, team-management-basics, virtual-assistant-masterclass."
version: 1.0.0
author: Project Charlie / Lana
license: Private/Internal
metadata:
  hermes:
    tags: ["finance", "operations", "team", "delegation", "hiring"]
    related_skills: ["charlie-business-foundations", "charlie-mindset-reality", "charlie-niche-offer", "charlie-expertise-methodology", "charlie-client-results", "charlie-sales-closing", "charlie-appointment-setting"]
---

# Charlie Operations Finance

Run the back-office — cashflow management, team building basics, and the virtual assistant masterclass.

## When to use

Use when the user is dealing with cashflow, agency finances, hiring, team management, SOPs, delegation, or building a remote/VA team.
...
- **managing-finances-cashflow** → `references/managing-finances-cashflow.md`
- **team-management-basics** → `references/team-management-basics.md`
- **virtual-assistant-masterclass** → `references/virtual-assistant-masterclass.md`
...
- **Mixing umbrellas**: if you're already inside `charlie-operations-finance`, don't also pull a sister umbrella unless the task genuinely spans both.

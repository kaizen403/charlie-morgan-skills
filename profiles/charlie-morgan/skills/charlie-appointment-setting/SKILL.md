---
name: charlie-appointment-setting
description: "How to fill the calendar — appointment setting fundamentals, inbound and outbound systems, and the rules governing which channel to invest in. Use when the user is building lead generation, choosing inbound vs outbound, designing cold outreach (email, DM, calling), running paid ads, content systems, or appointment-setter operations. Sub-topics: appointments-fundamentals, building-inbound-systems, building-outbound-systems, outbound-inbound-rulebook."
version: 1.0.0
author: Project Charlie / Lana
license: Private/Internal
metadata:
  hermes:
    tags: ["lead-gen", "outbound", "inbound", "appointments", "marketing"]
    related_skills: ["charlie-business-foundations", "charlie-mindset-reality", "charlie-niche-offer", "charlie-expertise-methodology", "charlie-client-results", "charlie-sales-closing", "charlie-operations-finance"]
---

# Charlie Appointment Setting

How to fill the calendar — appointment setting fundamentals, inbound and outbound systems, and the rules governing which channel to invest in.

## When to use

Use when the user is building lead generation, choosing inbound vs outbound, designing cold outreach (email, DM, calling), running paid ads, content systems, or appointment-setter operations.
...
- **appointments-fundamentals** → `references/appointments-fundamentals.md`
- **building-inbound-systems** → `references/building-inbound-systems.md`
- **building-outbound-systems** → `references/building-outbound-systems.md`
- **outbound-inbound-rulebook** → `references/outbound-inbound-rulebook.md`
...
- **Mixing umbrellas**: if you're already inside `charlie-appointment-setting`, don't also pull a sister umbrella unless the task genuinely spans both.
